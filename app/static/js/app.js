...
var SPEAKERS_ENDPOINT = "/static/js/fixtures/speakers.json";
var ORGANIZERS_ENDPOINT = "/static/js/fixtures/organizers.json";
var SPONSORS_ENDPOINT = "/static/js/fixtures/sponsors.json";
...
$(document).on("ready", function(){
    ...
    // Populate SPEAKERS
    $.getJSON( SPEAKERS_ENDPOINT, function( data ) {
        console.log(data);
    ...
    $.getJSON( ORGANIZERS_ENDPOINT, function( data ) {
        console.log(data);
        Notary.populate("organizer", data, "organizers", function($dom, obj){
